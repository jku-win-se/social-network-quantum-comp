 ...
 * @generated
 */
public class QCDeploymentSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case QCDeploymentPackage.ALGORITHM_EXECUTION: {
			AlgorithmExecution algorithmExecution = (AlgorithmExecution) theEObject;
			T result = caseAlgorithmExecution(algorithmExecution);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Algorithm Execution</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Algorithm Execution</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAlgorithmExecution(AlgorithmExecution object) {
		return null;
	}
