package jku.se.quantum.computing.generator.menu;
...
import jku.se.quantum.computing.generator.GeneratedJupiter;

public class JupiterExecutionHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (fileObj instanceof IFile) {
				...
				new GeneratedJupiter().doGenerate(snResource, jfsa , context);
				try {
					snFile.getProject().refreshLocal(1, new NullProgressMonitor());
				} catch (CoreException e) {
					e.printStackTrace();
				}
				System.out.println("Finish Jupiter Generation!");
			}			
		}		
		return null;
	}
